...
class HashMap:
    ...
    def put(self,key,value):
        ...
        new_node = LinkdeListNode(key,value)
        head = self.bucket_array[bucket_index]

        # Check if key is already present in the map, and Update its value accordingly
        ...
        '''
        If the key is a new one, hence not found in the chain (LinkedList) 
        ...
        In both cases, we will append the new node(key,value) at the beginning (head) of the chain (LinkedList)
        Remember that each bucket at position bucket_index is actually a chain with 1 or more nodes.
        '''
